package com.liu.map
{
	...
	public class MapContainerold extends Sprite implements IResizeDisplayObject
	{
		...
		public function MapContainerold()
		{
			init();
		}
		...
		private function loadRound(disX:Number,disY:Number):void{
